export default function SingingIcon() {
  return (
    <svg role="img" viewBox="0 0 50 50">
      <title>Singing Icon</title>
      <path
        d="M13.8,6.6c0.2,0.4,0,0.9-0.4,1c-0.9,0.4-1.6,1.1-2,2c-0.2,0.4-0.7,0.6-1.1,0.4C9.9,9.8,9.7,9.3,9.9,8.9
