export default function TravelIcon() {
  return (
    <svg role="img" viewBox="0 0 50 50">
      ...
      <path
        d="M36.1,34.5c3.3-1.6,5.5-4.8,5.5-6s-1.6-3.5-6.9,0.1c-1.5,1.1-4.2-1.1-5.3,0.5c-0.6,0.8,0.8,2.6,2.6,3.9
            C33.4,34.1,35.2,34.9,36.1,34.5z"
        fill="currentColor"
      />
      <path
        d="M25,2.2c-2.7,0-5.3,0.4-7.9,1.4c-0.6,0.2-1,0.9-0.7,1.5c0.2,0.6,0.9,1,1.5,0.7C20.2,5,22.6,4.6,25,4.6
      ...
      />
      <path
        d="M11.7,1c-0.7,0-1.2,0.5-1.2,1.2v5.1L6.8,11c-0.5,0.5-0.5,1.2,0,1.7C7.1,12.9,7.4,13,7.7,13
      ...
      />
      <path
        d="M5.6,14.8c-0.6-0.3-1.3,0-1.6,0.6c-1.5,3.2-2.3,6.5-2.3,10.1c0,12.8,10.4,23.2,23.2,23.2
